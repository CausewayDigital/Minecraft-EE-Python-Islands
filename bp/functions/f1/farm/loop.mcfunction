...
# If not tilled yet
execute @p[scores={f1-farm-plot-1=0,f1-farm-progress=1}] ~ ~ ~ particle minecraft:falling_dust_red_sand_particle -340 160 169
...
execute @p[scores={f1-farm-plot-1=1,f1-farm-progress=1}] ~ ~ ~ particle minecraft:falling_dust_top_snow_particle -340 160 169
...
execute @p[scores={f1-farm-plot-2=1,f1-farm-progress=1}] ~ ~ ~ detect -348 157 172 farmland 0 scoreboard players @p f1-farm-plot-2 1
execute @p[scores={f1-farm-plot-3=1,f1-farm-progress=1}] ~ ~ ~ detect -347 157 176 farmland 0 scoreboard players @p f1-farm-plot-3 1

execute @p[scores={f1-farm-plot-1=0,f1-farm-progress=1}] ~ ~ ~ detect -349 158 169 farmland 0 scoreboard players @p f1-farm-plot-1 1
