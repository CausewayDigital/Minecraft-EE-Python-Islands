...
execute @p[scores={f1-forest-apple=0}] ~ ~ ~ detect -350 159 216 air 0 setblock -350 159 216 barrier 0 replace
...
execute @p[scores={f1-forest-apple=1}] ~ ~ ~ detect -350 159 216 air 0 clone -349 147 223 -350 159 216
