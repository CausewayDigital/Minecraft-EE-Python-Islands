...
execute @p[scores={f1-forest-prog=4}] ~ ~ ~ detect -356 161 218 barrier 0 setblock -350 154 219 stone
...
execute @p[scores={f1-forest-prog=4}] ~ ~ ~ detect -356 161 218 barrier 0 setblock -350 154 223 stone
...
execute @p[scores={f1-forest-prog=4}] ~ ~ ~ detect -356 161 218 barrier 0 setblock -355 154 210 stone
...
execute @p[scores={f1-forest-prog=4}] ~ ~ ~ detect -356 161 218 barrier 0 setblock -350 154 216 stone
...
execute @p[scores={f1-forest-prog=4}] ~ ~ ~ detect -356 161 218 barrier 0 setblock -348 154 217 stone
...
execute @p[scores={f1-forest-prog=4}] ~ ~ ~ detect -356 161 218 barrier 0 setblock -348 154 220 stone
...
execute @p[scores={f1-forest-prog=4}] ~ ~ ~ detect -356 161 218 barrier 0 setblock -350 154 211 stone
