...
title @p[scores={f1-lake-progress=1}] actionbar Press C to open the code builder again
...
title @p[scores={f1-lake-progress=2}] actionbar Press C to open the code builder again
