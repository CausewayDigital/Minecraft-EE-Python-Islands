...
execute @p[scores={f2-farm-progress=1}, x=172 ,y=158, z=174, r=2] ~ ~ ~ codebuilder navigate @s true https://causewaydigital.github.io/Everglade-live/index.html?lesson=lessons/islands/island_1/Forest/Forest_1.json
