...
execute @p[scores={f2-farm-progress=1}, x=172 ,y=158, z=174, r=5] ~ ~ ~ codebuilder navigate @s false https://notebooks.minecrafteduservices.com/everglade/ci/index.html?lesson=https://causewaydigital.github.io/Everglade-live/lessons/islands/island_2/Farm/Farm.json
