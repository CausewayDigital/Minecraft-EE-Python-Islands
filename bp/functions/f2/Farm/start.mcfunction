...
execute @p ~ ~ ~ replaceitem entity @c[x=174 ,y=158, z=177] slot.inventory 0 concrete 64 5
execute @p ~ ~ ~ replaceitem entity @c[x=174 ,y=158, z=177] slot.inventory 1 concrete 64 14
