...
execute @p[scores={f2-forest-progre=2}] ~ ~ ~ tp @c 166 162 211 facing 167 162 211

# 3 = Teleport agent to the second block
execute @p[scores={f2-forest-progre=3}] ~ ~ ~ tp @c 160 162 213 facing 161 162 213

# 4 = Teleport agent to the third block
execute @p[scores={f2-forest-progre=4}] ~ ~ ~ tp @c 163 162 215 facing 164 162 215

# 5 = Teleport agent to the fourth block
execute @p[scores={f2-forest-progre=5}] ~ ~ ~ tp @c 165 162 219 facing 166 162 219

# 6 = Teleport agent to the fifth block
execute @p[scores={f2-forest-progre=6}] ~ ~ ~ tp @c 160 162 220 facing 161 162 220