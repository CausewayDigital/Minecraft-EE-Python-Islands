...
execute @e[type=horse, x=163, y=150, z=218, dx=10, dy=8, dz=10] ~ ~ ~ scoreboard players add @p f2-forest-progre 1
execute @e[type=horse, x=163, y=150, z=218, dx=10, dy=8, dz=10] ~ ~ ~ kill @s