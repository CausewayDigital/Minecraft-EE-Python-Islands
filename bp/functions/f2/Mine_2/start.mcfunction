...
execute @e[scores={f2-farm-complete=1,f2-forest-done=1},r=10,type=player] ~ ~ ~ codebuilder navigate @e[r=10,type=player] true https://notebooks.minecrafteduservices.com/everglade/prod/index.html?lesson=https://notebooks.minecrafteduservices.com/everglade/content/row/master/islands/island_2/Mine/Mine_2_start.json
