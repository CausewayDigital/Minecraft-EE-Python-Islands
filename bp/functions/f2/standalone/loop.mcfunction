...
execute @p[scores={f2-if-else-done=-1}, r=20, x=112, y=152, z=194] ~ ~ ~ scoreboard players set §r objective 200020
execute @p[scores={f2-if-else-done=-1}, r=20, x=112, y=152, z=194] ~ ~ ~ scoreboard players set @a f2-status 200020
