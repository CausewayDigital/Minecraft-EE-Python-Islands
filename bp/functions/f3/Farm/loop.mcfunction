...
execute @p[scores={f3-forest-comp=0}] ~ ~ ~ detect 131 154 606 air 0 clone 158 151 605 157 151 607 130 154 606 replace
execute @p[scores={f3-forest-comp=1}] ~ ~ ~ detect 131 154 606 fence 0 fill 130 154 606 131 154 608 air 0
