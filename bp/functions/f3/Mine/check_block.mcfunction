...
execute @s ~ ~ ~ detect 70 131 597 air 0 title @s title Block of gold ore mined!
...
execute @s ~ ~ ~ detect 67 131 597 air 0 title @s title Block of gold ore mined!
...
execute @s ~ ~ ~ detect 67 131 601 air 0 title @s title Block of gold ore mined!
