...
execute @p ~ ~ ~ detect 70 132 595 air 0 execute @s ~ ~ ~ detect 70 132 599 air 0 execute @s ~ ~ ~ detect 68 128 599 air 0 scoreboard players add @s f3-mine-prog 1
execute @s ~ ~ ~ detect 70 132 595 air 0 execute @s ~ ~ ~ detect 70 132 599 air 0 execute @s ~ ~ ~ detect 68 128 599 air 0 setblock 68 128 599 barrier 0 replace
