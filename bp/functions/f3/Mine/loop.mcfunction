...
# 2 to 26
execute @p[scores={f3-mine-prog=2..5}] ~ ~ ~ function f3/Mine/check_block

execute @p[scores={f3-mine-prog=5}] ~ ~ ~ function f3/Mine/quit
execute @p[scores={f3-mine-prog=10}] ~ ~ ~ function f3/Mine/quit

execute @p[scores={f3-mine-prog=2..5}, x=62, y=136, z=598, r=25] ~ ~ ~ title @s actionbar Press the C key to open the code builder again