...
# Librarian
execute @p[scores={f3-status=300030}] ~ ~ ~ particle minecraft:endrod 123 143 611

# Wizard
execute @p[scores={f3-status=300035}] ~ ~ ~ particle minecraft:endrod 89 172 628
execute @p[scores={f3-status=300040}] ~ ~ ~ particle minecraft:endrod 89 172 628
execute @p[scores={f3-status=300090}] ~ ~ ~ particle minecraft:endrod 89 172 628
execute @p[scores={f3-status=300110}] ~ ~ ~ particle minecraft:endrod 89 172 628

# Mine top
execute @p[scores={f3-status=300050}] ~ ~ ~ particle minecraft:endrod 66.9 150 601.9
execute @p[scores={f3-status=300070}] ~ ~ ~ particle minecraft:endrod 66.9 150 601.9

# Forest
execute @p[scores={f3-status=300060}] ~ ~ ~ particle minecraft:endrod 137 159 641

# Mine bottom
execute @p[scores={f3-status=300075}] ~ ~ ~ particle minecraft:endrod 61 139 600
