...
execute @p[r=5,scores={f3-library-done=0, f3-ship-h-done=1}] ~ ~ ~ codebuilder navigate @p true https://notebooks.minecrafteduservices.com/everglade/prod/index.html?lesson=https://notebooks.minecrafteduservices.com/everglade/content/row/master/islands/island_3/Wizard/wizard_to_library_1.json
