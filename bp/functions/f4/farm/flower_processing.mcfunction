...
execute @p[scores={f4-farm-prog=1}] ~ ~ ~ detect 1025 154 564 red_flower 0 clone 1025 154 564 1025 154 564 1016 154 563 replace

execute @p[scores={f4-farm-prog=2}] ~ ~ ~ detect 1025 154 564 red_flower 0 clone 1025 154 564 1025 154 564 1017 154 563 replace

execute @p[scores={f4-farm-prog=3}] ~ ~ ~ detect 1025 154 564 red_flower 0 clone 1025 154 564 1025 154 564 1018 154 563 replace

execute @p[scores={f4-farm-prog=4}] ~ ~ ~ detect 1025 154 564 red_flower 0 clone 1025 154 564 1025 154 564 1019 154 563 replace

execute @p[scores={f4-farm-prog=5}] ~ ~ ~ function f4/farm/finish
execute @p[scores={f4-farm-prog=5}] ~ ~ ~ detect 1025 154 564 red_flower 0 function f4/farm/fail
