...
execute @p[x=1023,y=155,z=636,r=5,scores={f4-status=400000..400028}] ~ ~ ~ detect 1023 155 635 air 0 clone 1049 148 650 1048 149 651 1022 155 635 replace
execute @p[x=1023,y=155,z=636,r=5,scores={f4-status=400029..400100}] ~ ~ ~ detect 1023 155 635 fence 1 fill 1023 155 635 1022 156 636 air 0

#Block off the airship entrance
execute @p[x=1023,y=155,z=636,r=5,scores={f4-status=400000..400048}] ~ ~ ~ detect 1039 156 645 air 0 clone 1042 148 641 1042 148 643 1039 156 645 replace
execute @p[x=1023,y=155,z=636,r=5,scores={f4-status=400049..400100}] ~ ~ ~ detect 1039 156 645 fence 1 fill 1039 156 645 1039 156 647 air 0

#Destroy Dispensers and redstone
execute @p[scores={f4-forest-d-t=1..15}] ~ ~ ~ scoreboard players add @p f4-forest-d-t 1
execute @p[scores={f4-forest-d-t=10}] ~ ~ ~ fill 1045 156 656 1045 155 655 air 0
execute @p[scores={f4-forest-d-t=10}] ~ ~ ~ fill 1045 156 652 1045 155 649 air 0
execute @p[scores={f4-forest-d-t=10}] ~ ~ ~ fill 1045 156 646 1045 155 646 air 0
