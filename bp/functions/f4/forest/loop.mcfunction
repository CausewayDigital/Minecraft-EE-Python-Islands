...
execute @p[scores={f4-forest-prog=1, f4-forest-title=1}] ~ ~ ~ detect 1045 156 656 concrete 8 codebuilder navigate @p true codebuilder navigate @p true https://minecraft.makecode.com/?ipc=1&lockedEditor=1&inGame=1#tutorial:https://github.com/CausewayDigital/Minecraft-EE-MakeCode/tutorials/python-islands/island-4/factory/factory_2
