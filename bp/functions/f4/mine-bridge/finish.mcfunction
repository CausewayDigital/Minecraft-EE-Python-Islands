...
execute @p[scores={f4-mine-b-comp=1, f4-mine-b-title=1}] ~ ~ ~ title @s subtitle Oh! There is an island over here.
execute @p[scores={f4-mine-b-comp=1, f4-mine-b-title=1}] ~ ~ ~ title @s title You Did It! ~ ~ ~ scoreboard players set @s f4-mine-b-title 2
