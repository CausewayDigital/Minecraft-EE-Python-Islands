...
execute @p[x=146,y=158,z=605,r=25,scores={f4-mine-b-prog=1}] ~ ~ ~ detect 937 150 626 fence 0 execute @s ~ ~ ~ fill 937 150 628 938 150 626 air 0
execute @p[x=, y=, z=, r=,scores={f4-mine-b-prog=1}] ~ ~ ~ effect @s blindness 169999 1 true
...
# Turn Blindness On
execute @p[x=936, y=150, z=627, r=2,scores={f4-mine-b-prog=1}] ~ ~ ~ effect @s blindness 169999 1 true

#Turn Blindness Off
execute @p[x=948, y=147, z=630, r=3,scores={f4-mine-b-prog=1}] ~ ~ ~ effect @s blindness 169999 1 false
execute @p[x=917, y=151, z=627, r=3,scores={f4-mine-b-prog=1}] ~ ~ ~ effect @s blindness 169999 1 false
execute @p[scores={f4-mine-b-prog=0}] ~ ~ ~ effect @s blindness 169999 1 false
