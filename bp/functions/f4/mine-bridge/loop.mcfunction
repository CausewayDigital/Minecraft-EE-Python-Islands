...
execute @p[x=146,y=158,z=605,r=25,scores={f4-mine-b-prog=1}] ~ ~ ~ fill 937 150 626 938 150 628 air 0
...
# Turn Blindness On
execute @p[x=936, y=150, z=627, r=2, scores={f4-mine-b-prog=1..6, f4-mine-b-blinded=0}] ~ ~ ~ function f4/mine-bridge/blinded
