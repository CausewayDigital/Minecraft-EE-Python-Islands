...
execute @p[x=936,y=150,z=627,r=10,scores={f4-mine-b-prog=0, f4-prog=0}] ~ ~ ~ detect 937 150 626 air 0 execute @p ~ ~ ~ clone 948 126 621 949 126 619 937 150 626 replace
execute @p[x=936,y=150,z=627,r=10,scores={f4-mine-b-prog=1..20}] ~ ~ ~ detect 937 150 626 fence 1 execute @p ~ ~ ~ fill 937 150 626 937 150 628 air 0
execute @p[x=936,y=150,z=627,r=10,scores={f4-prog=1..10}] ~ ~ ~ detect 937 150 626 fence 1 execute @p ~ ~ ~ fill 937 150 626 937 150 628 air 0
