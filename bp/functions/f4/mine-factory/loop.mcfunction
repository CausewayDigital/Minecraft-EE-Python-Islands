...
execute @p[x=936,y=150,z=627,r=30,scores={f4-mine-b-comp=0}] ~ ~ ~ detect 941 147 619 air 0 execute @p ~ ~ ~ clone 945 126 621 946 126 619 940 147 619 replace
execute @p[x=936,y=150,z=627,r=30,scores={f4-mine-b-comp=1}] ~ ~ ~ detect 941 147 619 fence 1 execute @p ~ ~ ~ fill 941 147 619 941 147 621 air 0
