...
execute @p[scores={f4-mine-f-prog=3}] ~ ~ ~ detect 949 144 611 wool 3 execute @s ~ ~ ~ title @s title Oh no, thats the wrong block!
execute @p[scores={f4-mine-f-prog=3}] ~ ~ ~ detect 949 144 611 wool 3 execute @s ~ ~ ~ title @s subtitle Go back to Frankie and abort the mission and start agin to reset.
