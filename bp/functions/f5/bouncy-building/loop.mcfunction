...
#Block off task
#Door one
execute @p[x=1019, y=159, z=74, r=10, scores={f5-status=500000..500029, f5-active=1}] ~ ~ ~ detect 1019 159 73 iron_door 0 setblock 1019 159 73 iron_door 3
execute @p[x=1019, y=159, z=74, r=10, scores={f5-status=500030..500100, f5-active=1}] ~ ~ ~ detect 1019 159 73 iron_door 3 setblock 1019 159 73 iron_door 0
