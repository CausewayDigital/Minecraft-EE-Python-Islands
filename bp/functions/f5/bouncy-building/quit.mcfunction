...
execute @p[x=1019, y=159, z=68, r=30, scores={f4-b-b-comp=0}] ~ ~ ~ title @p title Oh no...
execute @p[x=1019, y=159, z=68, r=30, scores={f4-b-b-comp=0}] ~ ~ ~ title @p subtitle Leaving Mission. You can start it again anytime. 
