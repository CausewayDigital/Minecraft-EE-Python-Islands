...
# Rescue players
title @a[x=1069,y=30,z=182,dx=-151,dy=10,dz=-145] subtitle Be a bit more careful next time!
title @a[x=1069,y=130,z=182,dx=-151,dy=10,dz=-145] title You nearly fell!
