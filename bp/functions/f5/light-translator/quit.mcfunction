...
execute @p[x=1010, y=154, z=137, r=30, scores={f4-l-t-comp=0}] ~ ~ ~ title @p title Oh no...
execute @p[x=1010, y=154, z=137, r=30, scores={f4-l-t-comp=0}] ~ ~ ~ title @p subtitle Leaving Mission. You can start it again anytime. 
