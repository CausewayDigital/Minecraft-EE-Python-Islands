...
execute @p[scores={f5-status=500060}] ~ ~ ~ title @p title World Complete!
execute @p[scores={f5-status=500060}] ~ ~ ~ title @p subtitle You have finished Island 5

execute @p[scores={f5-status=500060}] ~ ~ ~ function f5/npcs/particles
