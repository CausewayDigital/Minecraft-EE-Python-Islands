...
execute @p[scores={f5-tower-prog=7, f5-tower-title=0}] ~ ~ ~ title @p subtitle Now lets do the others
...
#Action bar
execute @p[scores={f5-tower-prog=1..10}] ~ ~ ~ title @p actionbar Press "C" to code or touch the Agent icon
