...
execute @p[x=1000,y=143,z=120,r=10, scores={f6-status=600000..600019, f6-active=1}] ~ ~ ~ detect 1025 153 132 air 0 fill 1025 153 132 1026 154 132 fence 0
execute @p[x=1000,y=143,z=120,r=10, scores={f6-status=600020..600100, f6-active=1}] ~ ~ ~ detect 1025 153 132 fence 0 fill 1025 153 132 1026 154 132 air 0
