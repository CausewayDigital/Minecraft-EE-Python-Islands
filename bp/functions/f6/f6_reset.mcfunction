...
execute @p[x=958,y=146,z=121,r=10, scores={f6-status=600000..600049, f6-active=1}] ~ ~ ~ fill 987 153 122 987 155 120 iron_bars
execute @p[x=958,y=146,z=121,r=10, scores={f6-status=600000..600049, f6-active=1}] ~ ~ ~ clone 1013 151 63 1013 151 63 988 154 121 replace
