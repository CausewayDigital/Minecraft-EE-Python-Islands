scoreboard players set §r objective 600070
scoreboard players set @a f6-status 600070
...
#Open Subway
#School
fill 1018 152 114 1016 154 114 air 0
...
setblock 1026 154 133 air 0

#Rocket
fill 1047 151 144 1046 153 144 air 0
setblock 1046 153 143 air 0
