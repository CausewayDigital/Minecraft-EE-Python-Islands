...
scoreboard players set @s f6-status 0

scoreboard objectives remove f6-active
scoreboard objectives add f6-active dummy 
scoreboard players set @a f6-active 0
scoreboard players set @s f6-active 0
...
scoreboard players set @s f6-dig-prog 0
...
scoreboard players set @s f6-dig-comp 0
...
scoreboard players set @s f6-dig-count 0
...
scoreboard players set @s f6-plant-prog 0
...
scoreboard players set @s f6-plant-comp 0
...
scoreboard players set @s f6-rocket-prog 0
...
scoreboard players set @s f6-rocket-comp 0
...
scoreboard players set @s f6-rocket-count 0
...
scoreboard players set @s f6-rocket-corect 0
...
scoreboard players set @s f6-runway-prog 0

scoreboard objectives remove f6-runway-comp
scoreboard objectives add f6-runway-comp dummy 
scoreboard players set @a f6-runway-comp 0
scoreboard players set @s f6-runway-comp 0

scoreboard objectives remove f6-runway-count
scoreboard objectives add f6-runway-count dummy 
scoreboard players set @a f6-runway-count 0
scoreboard players set @s f6-runway-count 0
