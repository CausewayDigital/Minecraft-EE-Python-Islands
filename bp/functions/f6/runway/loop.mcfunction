...
execute @p[x=949,y=141,z=120,r=10, scores={f6-status=600000..600049}] ~ ~ ~ detect 958 146 122 air 0 clone 1014 152 63 1014 152 63 959 148 121 replace
...
execute @p[x=949,y=141,z=120,r=10, scores={f6-status=600000..600049}] ~ ~ ~ detect 948 141 119 air 0 clone 1013 151 63 1013 151 63 949 142 120 replace
#Bridge Gate Open
...
execute @p[x=958,y=146,z=121,r=10, scores={f6-status=600050..600100}] ~ ~ ~ detect 1000 143 120 iron_bars 0 fill 959 148 121 959 148 121 air 0
#Subway Gate Open
