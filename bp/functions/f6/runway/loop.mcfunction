...
execute @p[x=958,y=146,z=121,r=10, scores={f6-status=600000..600049, f6-active=1}] ~ ~ ~ detect 958 148 121 air 0 clone 1013 151 63 1013 151 63 959 148 121 replace
