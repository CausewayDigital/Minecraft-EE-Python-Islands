...
scoreboard players set @p f7-zombie 0
scoreboard players set @p[x=-479, y=118, z=628, dx=20, dy=20, dz=24] f7-zombie 1

execute @p[scores={f7-zombie=1}] ~ ~ ~ detect -472 129 637 air -1 structure load zombie_spawner -472 129 637
execute @p[scores={f7-zombie=0}] ~ ~ ~ detect -472 129 637 mob_spawner -1 setblock -472 129 637 air 
